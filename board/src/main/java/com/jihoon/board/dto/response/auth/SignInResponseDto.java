...
public class SignInResponseDto {
    ...
    @ApiModelProperty(value="JWT", example="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJxd2VAcXdlLmNvbSIsImlhdCI6MTY3OTAzNTA0OSwiZXhwIjoxNjc5MDM4NjQ5fQ.degworIqJktJJCJ88bBG66svS7GN_a2QcybIHWp9ekM", required=true)
